...
| | |
|---|---|
| Site | https://www.microsaasexamples.com |
...
- **`/submit` = public form.** Fields: `company`, `name`, `email`, `url` + paid lanes ("Pay" buttons) and a "Copy badge code" widget. No CAPTCHA observed.
