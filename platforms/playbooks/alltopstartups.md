...
## Notes
submit-startup path exists; verified live 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- `/submit-startup/` exists but rendered only a search field — likely an editorial-pitch page or contact form that didn't render logged-out. UNVERIFIED.
