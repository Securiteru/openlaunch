...
## Notes
submit-startup path; verified live 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- `/login` — username+password or "Login with Twitter". No signup link visible — signup path UNVERIFIED.
