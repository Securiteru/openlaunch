...
## Notes
submit-a-startup path; verified live 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- `/submit-startup/` exists but rendered search fields only — actual pitch form is likely a contact plugin; UNVERIFIED.
