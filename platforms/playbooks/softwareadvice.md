...
## Notes
Gartner Digital Markets portal (shared w/ Capterra/GetApp); verified 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- **Gartner Digital Markets family** — vendor portal via `app.g2digitalmarkets.com` (shared with Capterra + GetApp).
