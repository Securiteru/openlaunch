...
## Notes
app review submit path; verified live 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- `/submit-app-for-review/` = WP page, no form fields rendered (search only). Probably instructions/contact — app-review site.
