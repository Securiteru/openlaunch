...
## Notes
Gartner Digital Markets vendor portal (shared w/ Capterra); bot-walled; verified reachable 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- Vendor login → `app.g2digitalmarkets.com/login` — **Gartner Digital Markets family** (same portal as Capterra + SoftwareAdvice). One vendor account covers all three.
