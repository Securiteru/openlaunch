...
## Notes
startup-list editorial path; verified live 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- `/startup-list/` = sponsored Seattle-area startup list; join path not observed on page — likely contact the editorial team.
