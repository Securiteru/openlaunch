...
## Notes
Nordic startup press; bot-walled to curl; verified reachable 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- Editorial Nordic press — no self-serve listing; pitch via contact. Newsletter form (Hustle WP plugin) only.
