...
| | |
|---|---|
| Site | https://www.builtinchicago.org |
| Category | press |
...
## Notes
send-us-tip editorial path; bot-walled; verified reachable 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- `/contact/send_us_tip` hit a Cloudflare "Just a moment..." challenge — bot-walled; needs interactive session.
