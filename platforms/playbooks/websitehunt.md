...
- `/websites/submit/create` → Django allauth `/accounts/login/?next=` — email+password + "Continue with Google" + `/accounts/signup/`. Post-login fields UNVERIFIED.
