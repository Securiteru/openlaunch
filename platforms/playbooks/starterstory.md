...
## Notes
founder-story platform; verified live 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- Email magic-link login (`/email_links/create`) + "Continue with Google" + reCAPTCHA. Editorial founder-interview site — listing = pitched story, not self-serve.
