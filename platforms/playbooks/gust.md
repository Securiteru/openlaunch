...
## Notes
startup/funding profile platform; bot-walled; verified reachable 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- `launch.gust.com/login` → `gust.com/users/sign_in` — Rails Devise email+password+remember_me. Gust is a startup/funding platform; listing = company profile.
