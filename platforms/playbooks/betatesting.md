...
## Notes
beta-testing platform; verified live 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- Paid beta-testing service — `/signup` + `/login`; "Get Started" → signup. Field details UNVERIFIED.

### Signup — observed 2026-09-19 (BrowserOS, field-level)

- `/signup` renders a JS-driven form (empty in static probe — modal-based). Paid beta-testing service regardless.
