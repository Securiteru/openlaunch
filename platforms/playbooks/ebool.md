...
## Notes
/submit path; verified live 2026-09-19


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- `/submit` — public listing form behind reCAPTCHA + FAQ accordion (approval time, listing terms, permanence). Vendor Portal at `/login`. Actual field list needs one more probe after cookie accept.
