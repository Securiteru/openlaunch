...
## Notes
curated directory; verified live 2026-09-19 (PlacesToPostYourStartup)


### Submit — observed 2026-09-19 (BrowserOS, field-level)

- Homepage is a bookmark/startpage product with ad redirects (viglink/trovi). "Add your faves" = user bookmarks, not a listing flow. Low-value for launches — consider `skipped`.
