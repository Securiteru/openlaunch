...
| Registry | `platforms/platforms.csv` | 77 seeded platforms: launch sites, AI-tool directories, SaaS directories — including each one's product-page URL pattern where known. |
...
- **77 platforms seeded.** The registry was bootstrapped from the public
  badge wall of a shipping product in this space. Playbook fields start
  `UNVERIFIED` and become accurate as agents verify them on real submissions.
